...
const Checkbox = ({ scale = scales.SM, display = 'block', className, background, ...props }: CheckboxProps | any) => {
  ...
  return (
    ...
    >
      <input type="checkbox" sx={{ variant: 'checkbox', background: background }} {...props} />
